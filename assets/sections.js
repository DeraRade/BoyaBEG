...
if (variant && variant.available === true) {
  ...
  } else if (variant.inventory_policy === 'continue'&& variant.inventory_management) {
    $('.items_left', $product).html("Not in stock. Pre-orders accepted. We will contact you with the estimated delivery time.");
  } else {
